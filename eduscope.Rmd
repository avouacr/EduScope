...
carto_etab_proxy %>%
  ...
  pub_hors_ep <- (data_simul_college_sub_carte %>% filter(secteur=="public" & ep=="Hors EP"))
      ...
      pub_rep <- (data_simul_college_sub_carte %>% filter(secteur=="public" & ep=="REP"))
      ...
      # Collèges Publics REP+
      pub_rep_plus <- (data_simul_college_sub_carte %>% filter(secteur=="public" & ep=="REP+"))
