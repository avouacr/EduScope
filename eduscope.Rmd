...
if (!("CONTOURS-IRIS.shp" %in% dir("data/shp"))) {
  unzip("contours_iris_wgs84.zip", exdir = "data/shp")
}
iris_shp <- st_read("contours_iris_wgs84.zip", 
                    crs = 4326, stringsAsFactors = FALSE)
...
#   iconUrl = "E:/CNESCO/Garde/Cartographie intéractive (Hugo)/Data/Picto_etab_public_violet.png",
#   #iconUrl ="C:/Users/hbotton/Documents/test_camemb.jpg",
#   #iconWidth = 30, iconHeight = 30,
#   iconWidth =df_college_idf$effectif_1er_cycle[df_college_idf$secteur=="public"&df_college_idf$ep=="Hors EP"]/15,
#   iconHeight =df_college_idf$effectif_1er_cycle[df_college_idf$secteur=="public"&df_college_idf$ep=="Hors EP"]/13,
#   iconAnchorX = 0, iconAnchorY = 0
# )
# 
# greenLeafIcon_prive <- makeIcon(
#   iconUrl = "E:/CNESCO/Garde/Cartographie intéractive (Hugo)/Data/Picto_etab_prive.png",
#   #iconWidth = 30, iconHeight = 30,
#   iconWidth =df_college_idf$effectif_1er_cycle[df_college_idf$secteur=="privé sous contrat"]/15,
#   iconHeight =df_college_idf$effectif_1er_cycle[df_college_idf$secteur=="privé sous contrat"]/13,
#   iconAnchorX = 0, iconAnchorY = 0
# )
# 
# greenLeafIcon_rep <- makeIcon(
#   iconUrl = "E:/CNESCO/Garde/Cartographie intéractive (Hugo)/Data/Picto_etab_public_REP_rose.png",
#   #iconUrl ="C:/Users/hbotton/Documents/test_camemb.jpg",
#   #iconWidth = 30, iconHeight = 30,
#   iconWidth =df_college_idf$effectif_1er_cycle[df_college_idf$secteur=="public"&df_college_idf$ep=="REP"]/15,
#   iconHeight =df_college_idf$effectif_1er_cycle[df_college_idf$secteur=="public"&df_college_idf$ep=="REP"]/13,
#   iconAnchorX = 0, iconAnchorY = 0
# )
# 
# greenLeafIcon_rep_plus<- makeIcon(
#   iconUrl = "E:/CNESCO/Garde/Cartographie intéractive (Hugo)/Data/Picto_etab_public_REP+_rouge.png",
#   #iconUrl ="C:/Users/hbotton/Documents/test_camemb.jpg",
#   #iconWidth = 30, iconHeight = 30,
#   iconWidth =df_college_idf$effectif_1er_cycle[df_college_idf$secteur=="public"&df_college_idf$ep=="REP+"]/15,
#   iconHeight =df_college_idf$effectif_1er_cycle[df_college_idf$secteur=="public"&df_college_idf$ep=="REP+"]/13,
...
leaflet() %>% #####
      addProviderTiles("Esri.WorldImagery", group = "Satellite",options = providerTileOptions(minZoom=5,attribution="Données: MEN-Depp, APAE")) %>% 
        ...
        addPolygons(data = iris_shp[iris_shp$dep %in% data_simul_college$dep[data_simul_college$acad=="Toulouse"],], opacity = 0.4, 
                    color = "#020202", 
                    stroke = TRUE, weight = 1,group="Quartiers",
                    label=iris_shp$popup_nom_comm[iris_shp$dep %in% data_simul_college$dep[data_simul_college$acad=="Toulouse"]],
                    popup=iris_shp$popup_iris[iris_shp$dep %in% data_simul_college$dep[data_simul_college$acad=="Toulouse"]],
                    fill = T, fillColor = iris_shp$color_d10[iris_shp$dep %in% data_simul_college$dep[data_simul_college$acad=="Toulouse"]], 
                    fillOpacity = 0.5,highlight = highlightOptions(weight = 6, color = iris_shp$color_d10[iris_shp$dep %in% data_simul_college$dep[data_simul_college$acad=="Toulouse"]],bringToFront = TRUE)) %>%
