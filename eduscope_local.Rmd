...
```{r, include = FALSE}
<<<<<<< HEAD
# Chargement des packages (installation si nécessaire)
=======
# Chargement des packages (et installation si nécessaire)
>>>>>>> a949ab9bd6017382de40af119840e99ac1a8d22a
...
if (!("academies-20160209.shp" %in% dir("data/shp"))) {
...
if (!("departements-20140306-5m.shp" %in% dir("data/shp"))) {
...
### IPS : positionnement du collège par rapport aux autres établissements de l'académie
```{r }
...
### Moyenne aux épreuves du DNB : positionnement du collège par rapport aux autres établissements de l'académie
```{r }
...
------------------------------------------------------------------
```{r }
textAreaInput("comm_etab", label="Souhaitez-vous signaler des informations particulières concernant votre établissement ?", value = "...",height=250,width=1000)
```

Row {data-height=5}
------------------------------------------------------------------
```{r }
div(style = "padding: 0px 0px; margin-top:-5em",
